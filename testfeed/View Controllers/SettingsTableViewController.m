...
- (void)viewDidLoad {
    ...
    [self.showAvatarSwitch setOn:[[Preferences sharedPreferences] showAvatar]];
    NSLog(@"%d", [[Preferences sharedPreferences] showAvatar]);
}
...
- (IBAction)showAvatarSwitchValueChanged:(id)sender {
    [[Preferences sharedPreferences] setShowAvatar:self.showAvatarSwitch.isOn];
    NSLog(@"%d", [[Preferences sharedPreferences] showAvatar]);
}
